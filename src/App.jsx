...
function App() {
  ...
  return (
    <div className={`${styles.container} container mt-5 p-5 rounded`}>
      ...
      objetivo é oferecer uma maneira simples e rápida para que você saiba mais
      sobre sua saúde e tome decisões informadas sobre seu bem-estar.
      Experimente agora e descubra sua classificação de IMC!
      <Formulario
